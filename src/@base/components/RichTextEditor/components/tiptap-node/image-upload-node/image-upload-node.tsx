...
import { CloseIcon } from '@base/components/RichTextEditor/components/tiptap-icons/close-icon';
import '@base/components/RichTextEditor/components/tiptap-node/image-upload-node/image-upload-node.scss';
import { focusNextNode, isValidPosition } from '@base/components/RichTextEditor/lib/tiptap-utils';
