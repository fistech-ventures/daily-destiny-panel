...
import { CheckIcon } from '@base/components/RichTextEditor/components/tiptap-icons/check-icon';

import '@base/components/RichTextEditor/components/tiptap-ui-primitive/dropdown-menu/dropdown-menu.scss';
