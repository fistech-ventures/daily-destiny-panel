...
import '@base/components/RichTextEditor/components/tiptap-ui-primitive/toolbar/toolbar.scss';
...
import { useComposedRef } from '@base/components/RichTextEditor/hooks/use-composed-ref';
