...
} from '@base/components/RichTextEditor/lib/tiptap-utils';

// --- Icons ---
import { HeadingOneIcon } from '@base/components/RichTextEditor/components/tiptap-icons/heading-one-icon';
import { HeadingTwoIcon } from '@base/components/RichTextEditor/components/tiptap-icons/heading-two-icon';
import { HeadingThreeIcon } from '@base/components/RichTextEditor/components/tiptap-icons/heading-three-icon';
import { HeadingFourIcon } from '@base/components/RichTextEditor/components/tiptap-icons/heading-four-icon';
import { HeadingFiveIcon } from '@base/components/RichTextEditor/components/tiptap-icons/heading-five-icon';
import { HeadingSixIcon } from '@base/components/RichTextEditor/components/tiptap-icons/heading-six-icon';
