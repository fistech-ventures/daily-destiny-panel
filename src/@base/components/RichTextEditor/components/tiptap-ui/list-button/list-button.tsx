...
// --- Tiptap UI ---
import type { ListType, UseListConfig } from '@base/components/RichTextEditor/components/tiptap-ui/list-button';
import { LIST_SHORTCUT_KEYS, useList } from '@base/components/RichTextEditor/components/tiptap-ui/list-button';
