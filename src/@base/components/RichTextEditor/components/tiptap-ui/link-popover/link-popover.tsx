...
// --- Icons ---
import { CornerDownLeftIcon } from '@base/components/RichTextEditor/components/tiptap-icons/corner-down-left-icon';
import { ExternalLinkIcon } from '@base/components/RichTextEditor/components/tiptap-icons/external-link-icon';
...
// --- Tiptap UI ---
import type { UseLinkPopoverConfig } from '@base/components/RichTextEditor/components/tiptap-ui/link-popover';
import { useLinkPopover } from '@base/components/RichTextEditor/components/tiptap-ui/link-popover';

// --- UI Primitives ---
import type { ButtonProps } from '@base/components/RichTextEditor/components/tiptap-ui-primitive/button';
import { Button } from '@base/components/RichTextEditor/components/tiptap-ui-primitive/button';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from '@base/components/RichTextEditor/components/tiptap-ui-primitive/popover';
import { Separator } from '@base/components/RichTextEditor/components/tiptap-ui-primitive/separator';
import { Card, CardBody, CardItemGroup } from '@base/components/RichTextEditor/components/tiptap-ui-primitive/card';
import { Input } from '@base/components/RichTextEditor/components/tiptap-ui-primitive/input';
import { ButtonGroup } from '@base/components/RichTextEditor/components/tiptap-ui-primitive/button-group';
