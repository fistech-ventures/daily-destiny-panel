...
// --- Icons ---
import { ListIcon } from '@base/components/RichTextEditor/components/tiptap-icons/list-icon';
import { ListOrderedIcon } from '@base/components/RichTextEditor/components/tiptap-icons/list-ordered-icon';
import { ListTodoIcon } from '@base/components/RichTextEditor/components/tiptap-icons/list-todo-icon';

// --- Lib ---
import { isNodeInSchema } from '@base/components/RichTextEditor/lib/tiptap-utils';
...
import {
  ...
  listIcons,
  type ListType,
} from '@base/components/RichTextEditor/components/tiptap-ui/list-button';
