...
// --- Lib ---
import { isExtensionAvailable, isNodeTypeSelected } from '@base/components/RichTextEditor/lib/tiptap-utils';

// --- Icons ---
import { AlignCenterIcon } from '@base/components/RichTextEditor/components/tiptap-icons/align-center-icon';
import { AlignJustifyIcon } from '@base/components/RichTextEditor/components/tiptap-icons/align-justify-icon';
import { AlignLeftIcon } from '@base/components/RichTextEditor/components/tiptap-icons/align-left-icon';
import { AlignRightIcon } from '@base/components/RichTextEditor/components/tiptap-icons/align-right-icon';
