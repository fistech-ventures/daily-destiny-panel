...
// --- Lib ---
import { isExtensionAvailable } from '@base/components/RichTextEditor/lib/tiptap-utils';

// --- Icons ---
import { ImagePlusIcon } from '@base/components/RichTextEditor/components/tiptap-icons/image-plus-icon';
