    ...
    <React.Fragment>
      ...
      <Drawer width={640} title="Create a new E-Paper" open={isDrawerOpen} onClose={() => setDrawerOpen(false)}>
        <EpapersForm
          ...
          onFinish={(values) => epaperCreateFn.mutate(values)}
        />
      </Drawer>
      <Drawer width={800} title="Bulk Upload E-Papers" open={isBulkDrawerOpen} onClose={() => setBulkDrawerOpen(false)}>
        <EpapersBulkUploadForm
          form={bulkFormInstance}
          isLoading={epaperBulkUploadFn.isPending}
