...
import { IPagesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IPagesFilter;
  onChange: (values: IPagesFilter) => void;
}

const PagesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
