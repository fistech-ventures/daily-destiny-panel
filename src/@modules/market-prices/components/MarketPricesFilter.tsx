...
import { IMarketPricesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IMarketPricesFilter;
  onChange: (values: IMarketPricesFilter) => void;
}

const MarketPricesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
  ...
  useEffect(() => {
    ...
    if (values?.startDate && values?.endDate) {
      values.dateRange.push(dayjs(values.startDate) as any);
      values.dateRange.push(dayjs(values.endDate) as any);
...
export default MarketPricesFilter;
