...
import { IStartupsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IStartupsFilter;
  onChange: (values: IStartupsFilter) => void;
}

const StartupsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
