...
import { IEntrepreneursFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IEntrepreneursFilter;
  onChange: (values: IEntrepreneursFilter) => void;
}

const EntrepreneursFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
...
export default EntrepreneursFilter;
