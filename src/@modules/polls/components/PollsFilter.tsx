...
import { IPollsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IPollsFilter;
  onChange: (values: IPollsFilter) => void;
}

const PollsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
