...
import { ISubCategoriesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: ISubCategoriesFilter;
  onChange: (values: ISubCategoriesFilter) => void;
}

const SubCategoriesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
