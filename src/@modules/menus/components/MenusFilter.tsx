...
import { IMenusFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IMenusFilter;
  onChange: (values: IMenusFilter) => void;
}

const MenusFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
