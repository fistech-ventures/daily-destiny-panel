...
import { ICategoriesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: ICategoriesFilter;
  onChange: (values: ICategoriesFilter) => void;
}

const CategoriesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
