...
import { IAuthorsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IAuthorsFilter;
  onChange: (values: IAuthorsFilter) => void;
}

const AuthorsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
